...
data_dir=/nfs/data/cv/pub/mscoco/coco_2014
params_file=https://dl.fbaipublicfiles.com/fair_self_supervision_benchmark/models/caffenet_bvlc_in1k_supervised.npy
features_dir=/tmp-network/user/mbsariyi/ssl-benchmark/alexnet-in1k/coco2014/features
svm_output_dir=/tmp-network/user/mbsariyi/ssl-benchmark/alexnet-in1k/coco2014/svm
